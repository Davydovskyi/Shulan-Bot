...
public class MessageUtil {
    ...
    public static final String DOC_IS_UPLOADED_MESSAGE = "Document is uploaded. Link to download: http://test.ru/get-doc/777";
    public static final String PHOTO_IS_UPLOADED_MESSAGE = "Photo is uploaded. Link to download: http://test.ru/get-photo/777";
